...
k = 1 ## pocet susedov z ktorych vyberame
num_points = 10000 ## pocet bodov pre triedu

# KD-Tree štruktúra
class KDNode:
    def __init__(self, point, axis):
        self.point = point  # Bod
        self.axis = axis    # Osa rozdelenia (0 pre X, 1 pre Y)
        self.left = None    # Ľavý potomok
        self.right = None   # Pravý potomok
